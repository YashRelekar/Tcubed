...
Pi 5 hardware notes
-------------------
* Microphone  : reSpeaker XVF3800 (USB 2886:001a) — 48 kHz, 4-channel
* Speaker     : Bluetooth A2DP via PipeWire (system default sink)
* Camera      : IMX219 MIPI via libcamera (see senses/camera.py)

Device selection is fully driven by env vars / config.json — no hard-coded
paths.  See .env.example for available knobs.
"""
...
class Orchestrator:
    ...
    def __init__(self, config: Config):
        ...
        # Audio — pass device names from config so env vars take effect
        print("  - Audio manager")
        ...
        # Senses — wake word detector uses mic_name from config
